export function templateA({ titulo, subtitulo, cta, cor, fotoUrl, logoUrl, endereco }) {
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .pill-1 { display:inline-block; background:#FFF8EE; color:${cor}; font-family:'Fraunces', 'Noto Color Emoji', serif; font-size:78px; font-weight:900; line-height:1.2; padding:22px 56px; border-radius:999px; max-width:940px; }
    ...
    .pill-2 { display:inline-block; background:${cor}; color:#fff; font-family:'Nunito', 'Noto Color Emoji', sans-serif; font-size:52px; font-weight:700; line-height:1.25; padding:18px 50px; border-radius:999px; max-width:940px; }
    ...
    .faixa-end { font-family:'Nunito', 'Noto Color Emoji', sans-serif; font-size:36px; font-weight:700; color:#FFF8EE; white-space:nowrap; }
